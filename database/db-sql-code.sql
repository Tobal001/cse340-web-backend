...
CREATE TABLE IF NOT EXISTS public.inventory (
    ...
    g NOT NULL,
    inv_model character varyin inv_year character(4) NOT NULL,
...
--3.Create relationship betweeen 'classification' and 'invintory' tables
ALTER TABLE IF EXISTS public.inventory
ADD CONSTRAINT fk_classificaiton FOREIGN KEY (classification_id) REFERENCES public.classification (classification_id) MATCH SIMPLE ON UPDATE CASCADE ON DELETE NO ACTION;
...
--6. update inventory description & image, thumbnail   
...
CREATE TABLE IF NOT EXISTS public.reviews (
    ...
    review_time_stamp TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT fk_inventory FOREIGN KEY (inv_id) REFERENCES inventory(inv_id),
